...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--results_dir', type=str, default='/ParkCounty/home/DFDNet_data/2-RESULTS', help='saves results here.')
        ...
        parser.add_argument('--test_dir', type=str, default='/ParkCounty/home/DFENet_data/1-IMPORT', help='Directory to import testing images.')
