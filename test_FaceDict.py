...
def main():
    ...
    if opt.only_final:
        shutil.rmtree(ResultsDir + '/Step0_Input')
        shutil.rmtree(ResultsDir + '/Step1_AffineParam')
        shutil.rmtree(ResultsDir + '/Step1_CropImg')
        shutil.rmtree(ResultsDir + '/Step2_Landmarks')
